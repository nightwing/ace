...
"use strict";
import { HashHandler } from 'ace/keyboard/hash_handler.js';
import { Editor } from 'ace/editor.js';
import { snippetManager } from 'ace/snippets.js';
import { Range } from 'ace/range.js';
var emmet, emmetPath;
...
export const setCore = function(e) {
    if (typeof e == "string")
       emmetPath = e;
    else
       emmet = e;
