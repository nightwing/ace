...
var CsoundOrchestraHighlightRules = function() {
    ...
    /*
      ...
      python -c "import json; from _csound_builtins import OPCODES, DEPRECATED_OPCODES; print 'var.js opcodes = {};'.format(json.dumps(sorted(list(OPCODES)), indent=4)); print 'var deprecatedOpcodes = {};'.format(json.dumps(sorted(list(DEPRECATED_OPCODES)), indent=4))"
    */
...
export { CsoundOrchestraHighlightRules };
