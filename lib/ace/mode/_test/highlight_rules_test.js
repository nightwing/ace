...
function testMode(modeName, i) {
    console.log(padNumber(i+1, 3) + ") testing: \x1b[33m" + modeName + "\x1b[0m");
...
function testEqual(a) {
    var err;
    if (a[0] + "" !== a[1] + "") {
        console.log("expected \x1b[92m" + a[0] + "\x1b[0m")
        console.log("recieved \x1b[91m" + a[1] + "\x1b[0m");
        err = 1;
    }
